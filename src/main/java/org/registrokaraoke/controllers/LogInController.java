...
public class LogInController implements Initializable {
        ...
        alert.showAndWait().ifPresent(response -> {
            if (response == registerButtonType) {
                ...
                try {
                    ...
                    Usuario nuevoUsuario = new Usuario(nombre, email, edad, password);
    ...
    private boolean authenticateUser(String usuario, String contraseña) {
        ...
        // Si no es el administrador, buscar en la base de datos con correo y contraseña
        EntityManager em = emf.createEntityManager();
        try {
            Usuario usuarioDB = em.createQuery(
                    ...
                    .setParameter("correo", usuario)  // Aquí usamos "usuario" como correo
